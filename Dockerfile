...
RUN apt install -y git && \
    git clone https://github.com/agarny/libcellml libCellML && \
    git clone https://github.com/agarny/libopencor libOpenCOR && \
    git clone https://github.com/agarny/opencor OpenCOR

# Create an alias for our host's Desktop directory:

RUN ln -s Data/Desktop Desktop
